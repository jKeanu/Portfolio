        ...
        <footer className="w-full h-fit bg-[#090e22] sm:px-14  xl:px-80 flex flex-col px-7 lg:px-24 md:px-16 xsm:px-12">
            <div className="mt-auto w-full border-t-[1px] border-b-0 border-r-0 border-l-0 border-solid border-[#444c68c3] py-6
                ...
                <ul className="socials-list flex gap-x-1">
                    <li>
                        <a href="https://www.linkedin.com/in/john-keanu-anicete-990584213/" className="social-link">
                            <svg className="md:h-[50px] md:w-[50px] h-[35px] w-[35px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                5.08247 19.9715 4.91616 19.9078 4.76122C19.8441 4.60629 19.7494 4.466 19.6295 4.34895C19.5097 4.23191 19.3672 4.14059 
                                19.2108 4.08058C19.0544 4.02057 18.8874 3.99314 18.72 3.99997ZM9 17.34H6.67V10.21H9V17.34ZM7.89 9.12997C7.72741 9.13564 
                                7.5654 9.10762 7.41416 9.04768C7.26291 8.98774 7.12569 8.89717 7.01113 8.78166C6.89656 8.66615 6.80711 8.5282 6.74841 
                                8.37647C6.6897 8.22474 6.66301 8.06251 6.67 7.89997C6.66281 7.73567 6.69004 7.57169 6.74995 7.41854C6.80986 7.26538 6.90112 
                                7.12644 7.01787 7.01063C7.13463 6.89481 7.2743 6.80468 7.42793 6.74602C7.58157 6.68735 7.74577 6.66145 7.91 6.66997C8.07259 
                                6.66431 8.2346 6.69232 8.38584 6.75226C8.53709 6.8122 8.67431 6.90277 8.78887 7.01828C8.90344 7.13379 8.99289 7.27174 9.05159 
                                7.42347C9.1103 7.5752 9.13699 7.73743 9.13 7.89997C9.13719 8.06427 9.10996 8.22825 9.05005 8.3814C8.99014 8.53456 8.89888 
                                8.6735 8.78213 8.78931C8.66537 8.90513 8.5257 8.99526 8.37207 9.05392C8.21843 9.11259 8.05423 9.13849 7.89 9.12997ZM17.34 
                    ...
                    <li>
                        ...
                        <svg width="40px" height="40px" className="md:h-[40px] md:w-[40px] w-[30px] h-[30px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            1,.69,1.85V21c0,.27.16.59.67.5A10,10,0,0,0,12,2Z" fill="#ffffff"/>
                        </svg>
                        </a>
                    </li>
                </ul>
