        ...
        <div className="about-me-info-container flex justify-center lg:justify-between flex-wrap lg:flex-nowrap lg:gap-x-12 lg:gap-y-0 gap-y-10">
          ...
          >
            ...
            <p className="xl:text-2xl text-xl lg:max-w-[35rem] xl:max-w-none xl:w-[40rem] 2xl:w-[60rem] xxxl:w-[75rem] font-raleway text-wrap">
              My name is John, A full-stack web-developer with a strong
              foundation in the MERN stack and a wide range of other
              technologies. With a solid grounding in both front-end and
              back-end technologies, I enjoy the challenge of bringing ideas and
              curiosities come to life through coding.
            </p>
          </div>
        </div>
